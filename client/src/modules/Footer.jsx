            ...
            <div className="contact-wrapper">
                <div className="card card-info">
                    ...
                    <div className="card-info__wrapper">
                        <h6>ООО Вива-Трейд</h6>
                        <p>Телефон: <span>+7 (922) 888 05 55</span></p>
                        <p>Адрес: <span>ул. Поляничко 689</span></p>
                        //TODO Исправить ссылку на WhatsApp
                        <a href='https://wa.me/79068334482' className='whatsApp'>
                            <p>Нас можно найти в WhatsApp</p>
                ...
                <div className="card card-map hidden">
